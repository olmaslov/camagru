				...
				<div class="popup-left-corner toanim post">
					...
					<div class="row">
						...
						<div class="col-2 pcom">
							<i class="far fa-check-circle sendcomm" id="test0" onclick="clck('test0')"></i>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-5">
				<div class="popup-right-corner toanim post">
					...
					<div class="row">
						...
						<div class="col-2 pcom">
							<i class="far fa-check-circle sendcomm" id="test" onclick="clck('test')"></i>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-5">
				<div class="popup-left-corner toanim post" data-postid="10">
					...
					<div class="row">
						...
						<div class="col-2 pcom">
							<i class="far fa-check-circle sendcomm"></i>
						</div>
					</div>
				</div>
			</div>
